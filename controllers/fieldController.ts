...
export class FieldController {
    ...
    async getFieldByUser (req: Request, res: Response) : Promise<void> {
        try {
    ...
    async getField (req: Request, res: Response) : Promise<void> {
      ...
      async getFieldWithStatus (req: Request, res: Response) : Promise<void> {
        try {
            const userId = BigInt(String(req.query.userId));
      ...
      async createNewFields (req: Request, res: Response) : Promise<void> {
        try {
    ...
    async updateFieldData (req: Request, res: Response) : Promise<void> {
        try {
    ...
    async updateFieldStatus (req: Request, res: Response) : Promise<void> {
        try {
    ...
    async updateFieldPlantDate (req: Request, res: Response) : Promise<void> {
        try {
    ...
    async deleteFieldData (req: Request, res: Response) : Promise<void> {
        try {
